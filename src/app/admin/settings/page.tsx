import { KeyRound, Mail, Save, UsersRound } from "lucide-react";
import { updateCurrentUserEmailAction, updateCurrentUserPasswordAction } from "@/app/admin/actions";
    ...
    >
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <aside className="grid gap-4">
          <CreateOperatorForm stores={stores.map((store) => ({ id: store.id, name: store.name }))} />
